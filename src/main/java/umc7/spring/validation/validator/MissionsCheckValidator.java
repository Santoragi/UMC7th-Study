...
public class MissionsCheckValidator implements ConstraintValidator<CheckMissions, Long> {

    private final MissionQueryService missionQueryService;

    @Override
    public void initialize(CheckMissions constraintAnnotation) {
    ...
    public boolean isValid(Long missionId, ConstraintValidatorContext context) {
        ...
        boolean isValid = missionQueryService.checkMissionStatus(memberId, missionId);
        if(!isValid){
            context.disableDefaultConstraintViolation();
